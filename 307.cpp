...
public class SegmentTreeMinimumRangeQuery {
   ...
   */
  public vector<int> createSegmentTree(vector<int> input){
    ...
    int nextPowOfTwo = np2.nextPowerOf2(input.size());
   ...
   */
  public void updateSegmentTree(vector<int> input, vector<int> segmentTree, int index, int delta){
    input[index] += delta;
   ...
   */
  public void updateSegmentTreeRange(vector<int> input, vector<int> segmentTree, int startRange, int endRange, int delta) {
   ...
   */
  public int rangeMinimumQuery(vector<int> segmentTree,int qlow,int qhigh,int len){
   ...
   */
  public void updateSegmentTreeRangeLazy(vector<int> input, vector<int>
  segmentTree, vector<int> lazy, int startRange, int endRange, int delta) {
   ...
   */
  public int rangeMinimumQueryLazy(vector<int> segmentTree, vector<int> lazy, int qlow, int qhigh, int len) {
